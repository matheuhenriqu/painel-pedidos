...
-- Políticas para configuracoes_chatbot
DROP POLICY IF EXISTS "cfg_chatbot_public_select" ON configuracoes_chatbot;
CREATE POLICY "cfg_chatbot_public_select" ON configuracoes_chatbot FOR SELECT TO anon, authenticated USING (true);

DROP POLICY IF EXISTS "cfg_chatbot_admin_all" ON configuracoes_chatbot;
CREATE POLICY "cfg_chatbot_admin_all" ON configuracoes_chatbot FOR ALL TO authenticated USING (
